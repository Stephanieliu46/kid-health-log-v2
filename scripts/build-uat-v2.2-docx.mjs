...
const txtPath = path.join(repoRoot, "Kid Health Log - UAT Test Cases - v2.2.txt");
const outPath = path.join(
  path.dirname(repoRoot),
  "Kid Health Log - UAT Test Cases - v2.2.docx",
);
...
sectionBlocks.push(
  new Paragraph({
    ...
    children: [new TextRun({ text: "v2.2 Changelog", bold: true, size: 22 })],
  }),
);
