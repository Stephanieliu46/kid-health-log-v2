...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://kid-health-log-v2.vercel.app/logo.png" },
      { property: "og:url", content: "https://kid-health-log-v2.vercel.app/" },
      { name: "twitter:image", content: "https://kid-health-log-v2.vercel.app/logo.png" },
    ],
    links: [
      {
        rel: "stylesheet",
